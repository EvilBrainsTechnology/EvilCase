...
A case-file system for administrative and legal proceedings: a case relates to any number of other cases and accumulates acts, parties, file marks, tags and comments. Built so far — the domain model in PostgreSQL, authentication, and a Blazor WebAssembly frontend whose case screens are still placeholders.
