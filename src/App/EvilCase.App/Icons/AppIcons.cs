...
// The path data is copied from Tabler icons.
public static class AppIcons
{
    public const string AlertTriangle = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M12 9v4' />"
    ...
    public const string FileText = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
    ...
    public const string Folders = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M9 4h3l2 2h5a2 2 0 0 1 2 2v7a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-9a2 2 0 0 1 2 -2' />"
        + "<path d='M17 17v2a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-9a2 2 0 0 1 2 -2h2' />";

    public const string LayoutDashboard = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
    ...
    public const string Login = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M15 8v-2a2 2 0 0 0 -2 -2h-7a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h7a2 2 0 0 0 2 -2v-2' />"
        + "<path d='M21 12h-13l3 -3' />"
        + "<path d='M11 15l-3 -3' />";

    public const string Logout = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M14 8v-2a2 2 0 0 0 -2 -2h-7a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h7a2 2 0 0 0 2 -2v-2' />"
        + "<path d='M9 12h12l-3 -3' />"
        + "<path d='M18 15l3 -3' />";

    public const string Message = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M8 9h8' />"
        + "<path d='M8 13h6' />"
    ...
    public const string Pencil = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M4 20h4l10.5 -10.5a2.828 2.828 0 1 0 -4 -4l-10.5 10.5v4' />"
        + "<path d='M13.5 6.5l4 4' />";

    public const string Plus = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M12 5l0 14' />"
        + "<path d='M5 12l14 0' />";

    public const string Refresh = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M20 11a8.1 8.1 0 0 0 -15.5 -2m-.5 -4v4h4' />"
        + "<path d='M4 13a8.1 8.1 0 0 0 15.5 2m.5 4v-4h-4' />";

    public const string Scale = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M7 20l10 0' />"
        + "<path d='M6 6l6 -1l6 1' />"
        + "<path d='M12 3l0 17' />"
    ...
    public const string Search = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0' />"
        + "<path d='M21 21l-6 -6' />";

    public const string Settings = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
    ...
    public const string Trash = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M4 7l16 0' />"
        + "<path d='M10 11l0 6' />"
        + "<path d='M14 11l0 6' />"
    ...
    public const string Upload = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2' />"
        + "<path d='M7 9l5 -5l5 5' />"
        + "<path d='M12 4l0 12' />";

    public const string User = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        + "<path d='M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0' />"
        + "<path d='M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2' />";

    public const string Users = "<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
