...
// Tabler icons are not shipped in the TabBlazor package; the ones used by the app are declared here.
public static class AppIcons
{
    ...
    public static IIconType Settings { get; } = new TablerIcon("<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
        ...
        + ".37 -2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756 -.426 -1.756 -2.924 0 -3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94 -1.543 .826 -3.31 2.37 -2.37c1 .608 2.296 .07 2.572 -1.065z' />"
    ...
    public static IIconType CalendarEvent { get; } = new TablerIcon("<path stroke='none' d='M0 0h24v24H0z' fill='none' />"
