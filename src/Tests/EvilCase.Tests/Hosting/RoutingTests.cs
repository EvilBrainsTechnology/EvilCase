...
public class RoutingTests
{
    ...
    public async Task ControllerActionIsReachedUnderTheApiPrefix()
    {
        ...
        using var request = new HttpRequestMessage(HttpMethod.Get, new Uri("/api/cases?take=20", UriKind.Relative)) { Headers = { Authorization = TestTokens.BearerFrom(this.host) } };
