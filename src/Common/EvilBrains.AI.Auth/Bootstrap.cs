...
public static class Bootstrap
{
    ...
    public static WebApplicationBuilder AddEvilBrainsAIAuth(this WebApplicationBuilder builder, string authSettingsPath)
    {
    ...
    public static IServiceCollection AddEvilBrainsAIAuth(this IServiceCollection serviceCollection)
    {
        if (settingsPath is null)
            throw new InvalidOperationException("EvilBrainsAIAuth was not configured. Call AddEvilBrainsAIAuth on WebApplicationBuilder at startup.");
