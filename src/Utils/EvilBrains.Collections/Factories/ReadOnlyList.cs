...
public static class ReadOnlyList
{
    ...
    public static IReadOnlyList<T> Single<T>(T element)
    {
        return [element];
    }

    public static IReadOnlyList<T> From<T>(params IEnumerable<T> elements)
    {
        return [.. elements];
    }

    public static IReadOnlyList<T> Repeat<T>(T element, int count)
    {
