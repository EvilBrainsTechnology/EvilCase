...
namespace EvilBrains.EvilCase.Data.Migrations.Migrations
{
    ...
    [Migration("20260913222029_CascadeSubordinateCases")]
    partial class CascadeSubordinateCases
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EvilBrains.EvilCase.Data.Entities.Act", b =>
                {
                    ...
                    b.ToTable("Acts", t =>
                        {
                            t.HasCheckConstraint("CK_Acts_DirectionWithContact", "(\"Direction\" IS NULL) = (\"ContactId\" IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("EvilBrains.EvilCase.Data.Entities.Act", b =>
                {
                    ...
                    b.HasOne("EvilBrains.EvilCase.Data.Entities.Contact", "Contact")
                        .WithMany("Acts")
